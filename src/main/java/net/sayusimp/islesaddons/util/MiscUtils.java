...
public class MiscUtils {
    ...
    /* List of all mounts:
        Mule, Race Horse, VIP Horse, Noble Horse, Hero Horse, Legend Horse, Mythic Horse, Unicorn, Boar, Zombie, Strider,
        Hellhound, Skeleton Horse, Zombie Horse, Plaza Pig, Bee, Jack O'Ride, Clown cart
     */
    public static List<EntityType> mountTypes = Arrays.asList(EntityType.HORSE, EntityType.BEE, EntityType.SKELETON_HORSE, EntityType.ZOMBIE, EntityType.ZOMBIE_HORSE, EntityType.HOGLIN, EntityType.STRIDER, EntityType.PIG, EntityType.WOLF, EntityType.ARMOR_STAND);
